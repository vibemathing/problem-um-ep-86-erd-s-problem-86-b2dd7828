...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-86-erd-s-problem-86-b2dd7828-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-86"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-86-erd-s-problem-86-b2dd7828-v1",
      "problem_contract_sha256": "397207c75d89c1d092df3321fbe08bf36d6c7aa59e67c30cb122dec29fbaef87",
      "problem_id": "problem:um-ep-86-erd-s-problem-86-b2dd7828",
      "route_id": "route:um-ep-86-erd-s-problem-86-b2dd7828-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-86-erd-s-problem-86-b2dd7828-source-fidelity-01",
      "graph_id": "graph:um-ep-86-erd-s-problem-86-b2dd7828-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-86-erd-s-problem-86-b2dd7828-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-86-erd-s-problem-86-b2dd7828-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $Q_n$ be the $n$-dimensional hypercube graph (so that $Q_n$ has $2^n$ vertices and $n2^{n-1}$ edges). Is it true that every subgraph of $Q_n$ with $ \\geq \\left(\\frac{1}{2}+o(1)\\right)n2^{n-1} $ many edges contains a $C_4$?"
          },
          "statement_sha256": "89c78d81c99437742e7f9c3590226cfa89f68129019d7fe1c9849ae75faf7d97"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-86-erd-s-problem-86-b2dd7828-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-86-erd-s-problem-86-b2dd7828-root",
      "route_id": "route:um-ep-86-erd-s-problem-86-b2dd7828-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-86-4d144e7f72ee",
        "url": "https://www.unsolvedmath.com/problems/EP-86"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
